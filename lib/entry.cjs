...
var init_wasm_util_esm_bundler = __esm({
  "node_modules/.pnpm/@tybys+wasm-util@0.9.0/node_modules/@tybys/wasm-util/dist/wasm-util.esm-bundler.js"() {
    ...
    kExitCode = /* @__PURE__ */ Symbol("kExitCode");
    kSetMemory = /* @__PURE__ */ Symbol("kSetMemory");
    kStarted = /* @__PURE__ */ Symbol("kStarted");
    kInstance = /* @__PURE__ */ Symbol("kInstance");
    kBindingName = /* @__PURE__ */ Symbol("kBindingName");
    WASI = class {
